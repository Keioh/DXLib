...
{
	image[0].Load("res/dp/0.png");
	image[1].Load("res/dp/1.png");
	image[2].Load("res/dp/2.png");
	image[3].Load("res/dp/3.png");
	image[4].Load("res/dp/4.png");
	image[5].Load("res/dp/5.png");
	image[6].Load("res/dp/6.png");
	image[7].Load("res/dp/7.png");
	image[8].Load("res/dp/8.png");

	image[9].Load("res/dp/back.png");
