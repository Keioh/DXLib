...
{
	counter_icon_image.Load("res/effect/exclamation/0.png");

	move_image[0].Load("res/enemy/enemy_00/0.png");
	move_image[1].Load("res/enemy/enemy_00/1.png");
	move_image[2].Load("res/enemy/enemy_00/2.png");
	move_image[3].Load("res/enemy/enemy_00/3.png");
}
