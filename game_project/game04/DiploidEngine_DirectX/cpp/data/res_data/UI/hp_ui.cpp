...
{
	image[0].Load("texter/res/hp/0.png");
	image[1].Load("texter/res/hp/1.png");
	image[2].Load("texter/res/hp/2.png");
	image[3].Load("texter/res/hp/3.png");
	image[4].Load("texter/res/hp/4.png");
	image[5].Load("texter/res/hp/5.png");
	image[6].Load("texter/res/hp/6.png");
	image[7].Load("texter/res/hp/7.png");
	image[8].Load("texter/res/hp/8.png");

	image[9].Load("texter/res/hp/back.png");
}
